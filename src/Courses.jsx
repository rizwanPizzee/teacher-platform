    ...
    <div className="courses-container-outer">
          ...
          {courses.map((course, index) => (
            <div key={index} className="course-item">
              ...
              <div className="course-buttons">
                ...
                {course.name === "Introduction to Software Engineering (ISE)" ||
                course.name ===
                  ...
                  <button
                    ...
                    onClick={() => {
                      document.querySelector(".warning-preview").style.display =
                        "flex";
                    }}
                  >
                    Lectures
                  ...
                  <Link to="/courses/hci/lectures">
                    <button style={{ height: "33px" }} className="course-btn ">
                      Lectures
                    </button>
                  </Link>
                )}
      ...
      >
        <div className="warning-inner">
          <div>
            There is no ISE/OOSE lectures right now. You can check its videos or
            explore the HCI course.
          </div>
